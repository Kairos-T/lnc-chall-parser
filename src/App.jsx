    ...
    <div className="min-h-screen bg-gray-900 text-white font-sans flex justify-center py-6">
      <div className="w-full max-w-5xl p-6 space-y-8">
        ...
        <section className="space-y-4">
          ...
          {form.hints.length > 0 && (
            <Card className="h-96 bg-gray-800 text-white border border-gray-700 mt-4">
        ...
        <section className="space-y-4">
          ...
          {files.length > 0 && (
            <Card className="h-96 bg-gray-800 text-white border border-gray-700 transition-all duration-300 mt-4">
              <CardContent className="p-4 text-white">
                <ul className="list-disc ml-5 space-y-1">
                  {files.map((f, i) => (
                    <li key={i} className="flex justify-between items-center">
